...
Main {
    public static void main(String[] args) {
       ...
       /*B.5.	Restaurantul achiziționează un nou soft nou pentru lucrul de la bar, însă acesta nu este compatibil cu
        ...
        System.out.println("Adapter - B5 - RESTAURANT - ADAPTER DE CLASE");
        ISoftRestaurant softBucatarie=new SoftBucatarie("Pizza cu Ciuperci");
        softBucatarie.printeazaFactura();

        ISoftRestaurant adapter=new AdapterSoftBar("Limonada Rece");
